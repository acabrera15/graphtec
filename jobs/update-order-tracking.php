...
updateOrderTrackingForStore($bc_config, $gp_credentials);
...
function updateOrderTrackingForStore(BigCommerceApiCredentialsConfig $bc_config, SoapCredentialsConfig $gp_config): void
{
